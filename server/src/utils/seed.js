...
async function seed() {
  ...
  const products = await Product.insertMany([
    ...
    { code: 'SM-001', name: 'Bread (Proton)', category: 'Bakery', qty: 5, reorderLevel: 20, price: 1.2, cost: 0.8, icon: '🍞' },
    { code: 'SM-002', name: 'Fresh Milk 2L', category: 'Dairy', qty: 30, reorderLevel: 15, price: 2.4, cost: 1.7, icon: '🥛' },
    { code: 'SM-003', name: 'Mazoe Orange Crush 2L', category: 'Beverages', qty: 48, reorderLevel: 15, price: 3.2, cost: 2.3, icon: '🧃' },
    { code: 'SM-004', name: 'Coca-Cola 500ml', category: 'Beverages', qty: 96, reorderLevel: 24, price: 0.8, cost: 0.5, icon: '🥤' },
    { code: 'SM-005', name: 'Mineral Water 500ml', category: 'Beverages', qty: 120, reorderLevel: 30, price: 0.5, cost: 0.3, icon: '💧' },
    { code: 'SM-006', name: 'Maputi Snacks 100g', category: 'Snacks', qty: 60, reorderLevel: 20, price: 0.6, cost: 0.35, icon: '🍿' },
    { code: 'SM-007', name: 'Lays Chips 120g', category: 'Snacks', qty: 40, reorderLevel: 15, price: 1.5, cost: 1.0, icon: '🥔' },
    { code: 'SM-008', name: 'Biscuits Assorted', category: 'Snacks', qty: 35, reorderLevel: 12, price: 1.1, cost: 0.7, icon: '🍪' },
    { code: 'SM-009', name: 'Mealie Meal 10kg', category: 'Grocery', qty: 22, reorderLevel: 10, price: 8.5, cost: 6.8, icon: '🌽' },
    { code: 'SM-010', name: 'Cooking Oil 2L', category: 'Grocery', qty: 18, reorderLevel: 10, price: 4.2, cost: 3.3, icon: '🫙' },
    { code: 'SM-011', name: 'Sugar 2kg', category: 'Grocery', qty: 26, reorderLevel: 12, price: 2.6, cost: 2.0, icon: '🧂' },
    { code: 'SM-012', name: 'Rice 5kg', category: 'Grocery', qty: 16, reorderLevel: 8, price: 6.4, cost: 5.1, icon: '🍚' },
    { code: 'SM-013', name: 'Washing Powder 2kg', category: 'Household', qty: 20, reorderLevel: 8, price: 5.5, cost: 4.2, icon: '🧺' },
    { code: 'SM-014', name: 'Bar Soap', category: 'Household', qty: 55, reorderLevel: 20, price: 0.9, cost: 0.6, icon: '🧼' },
    { code: 'SM-015', name: 'Toilet Paper 2-Pack', category: 'Household', qty: 40, reorderLevel: 15, price: 1.8, cost: 1.2, icon: '🧻' },
    { code: 'SM-016', name: 'Eggs (Tray of 30)', category: 'Dairy', qty: 14, reorderLevel: 6, price: 4.8, cost: 3.9, icon: '🥚' },
    { code: 'SM-017', name: 'Cheese Slices 200g', category: 'Dairy', qty: 12, reorderLevel: 6, price: 3.1, cost: 2.4, icon: '🧀' },
    { code: 'SM-018', name: 'Scones (6-Pack)', category: 'Bakery', qty: 9, reorderLevel: 8, price: 1.6, cost: 1.0, icon: '🥐' },
  ]);
