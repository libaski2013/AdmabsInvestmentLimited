...
function CustView({ user }) {
  ...
  const shareStatement=async(mode='share')=>{
    ...
    const headers=['Date / Reference','Branch / Outlet','Transaction','Customer Debt','Customer Payments','Balance Due']; const xs=[14,46,82,129,150,171];pdf.setFillColor(20,55,130);pdf.rect(12,y,186,9,'F');pdf.setTextColor(255);pdf.setFont('helvetica','bold');pdf.setFontSize(7.5);headers.forEach((h,i)=>pdf.text(h,xs[i],y+6));y+=14;pdf.setTextColor(15,23,42);pdf.setFont('helvetica','normal');pdf.setFontSize(7.5);
